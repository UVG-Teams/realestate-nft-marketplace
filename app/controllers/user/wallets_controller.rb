class User::WalletsController < ApplicationController
    ...
    # @return Wallets fron every user
    def index
    ...
    # @return [nil] Nil if wallet deleted
    def destroy
        @user_wallet.destroy

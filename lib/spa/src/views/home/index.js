...
const Home = () => {
    ...
    const mint = () => {
        ...
        vesta.methods.set_house_detail("https://gateway.pinata.cloud/ipfs/QmbX4BNVdhRZJrecshrewWn93StaPZ3ku49RfwuF6HxdxD", "Castell", 1900, 150, 3, 2, 2, 4, true, false, "Arezzo, Italy").send({
            from: account,

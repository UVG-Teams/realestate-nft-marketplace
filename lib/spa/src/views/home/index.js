...
const Home = () => {
    ...
    const mint = () => {
        ...
        vesta.methods.set_house_detail("https://gateway.pinata.cloud/ipfs/QmbYyRqzRWpkRYFznbUCstMKqjrGf996T5BL2Q1RPeDMN6", "House", 2020, 150, 3, 2, 2, 4, true, false, "Arezzo, Italy").send({
            from: account,

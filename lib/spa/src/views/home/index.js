...
const Home = () => {
    ...
    const mint = () => {
        ...
        vesta.methods.set_house_detail("https://gateway.pinata.cloud/ipfs/QmbYyRqzRWpkRYFznbUCstMKqjrGf996T5BL2Q1RPeDMN6", "House", 2022, 250, 4, 5, 2, 4, true, false, "Rome, Italy").send({
            from: account,

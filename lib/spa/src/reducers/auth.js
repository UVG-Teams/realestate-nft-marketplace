...
export const selectors = {
    ...
    getGlobalAuthToken: state => state.auth.token,
    ...
    getAuthEmail: state => state.decoded ? state.decoded.email : null,
    getAuthFirstName: state => state.decoded ? state.decoded.first_name : null,
    getAuthLastName: state => state.decoded ? state.decoded.last_name : null,
    getAuthTelephone: state => state.decoded ? state.decoded.telephone : null,

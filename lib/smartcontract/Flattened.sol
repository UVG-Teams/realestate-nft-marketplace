...
contract Vesta is ERC721, ERC721Enumerable, VestaDNA {
    ...
    function _boolToString(bool _b) public pure returns (string memory) {
        return (_b ? 'Yes' : 'No');
    }
